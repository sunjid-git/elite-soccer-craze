        ...
        <div className="teamDetail">
          <div className="row m-3 rounded teamCardDetail">
            <div className="col-md-6 p-4">
              ...
              <p>
                ...
                <strong> Sports Type : </strong> {team.strSport}
              </p>
              <p>
                {" "}
                <FontAwesomeIcon icon={faVenusMars} />{" "}
                <strong> Gender : </strong> {team.strGender}
              </p>
            </div>

            <div className="col-md-6 p-4">
              {team.strGender === "Male" ? (
                <img className=" maleFemaleImg" src={male} alt="" />
              ) : (
                <img className=" maleFemaleImg" src={female} alt="" />
              )}
            </div>
          </div>
          ...
          <div className="d-flex justify-content-around">
            <div>
              ...
              <a
                href="https://www.facebook.com/groups/completewebdevelopment3"
                target="blank"
              >
